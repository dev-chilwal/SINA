...
def main():
    ...
    execution_time = open("./result1/execution_time" + ".txt", 'w')
    execution_time.write(str(elapsed_time))

    rec_list = open("./result1/reclist_top_" + str(top_k) + ".txt", 'w')
    result_5 = open("./result1/result_top_" + str(5) + ".txt", 'w')
    result_10 = open("./result1/result_top_" + str(10) + ".txt", 'w')
    result_15 = open("./result1/result_top_" + str(15) + ".txt", 'w')
    result_20 = open("./result1/result_top_" + str(20) + ".txt", 'w')
...
if __name__ == '__main__':
    data_dir = "/home/ubuntu/STACP/datasets/foursquare_u7642/"
